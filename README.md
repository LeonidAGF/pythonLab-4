...
- `AuthorBookDictCollection` Класс наследующий свойства BookDictCollection, но изменённый, так чтобы стандартный слоарь сопоставлял ключу список
- `YearBookDictCollection` Класс наследующий свойства BookDictCollection, но изменённый, так чтобы стандартный слоарь сопоставлял ключу список, изменнный метод remove
